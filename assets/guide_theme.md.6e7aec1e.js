...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span></code></pre></div><p>最后分享一篇关于暗黑模式的文章《<a href="http://www.woshipm.com/pd/4105894.html" target="_blank" rel="noreferrer">教你巧用UI设计中的暗黑模式——Dark Mode</a>》，希望帮助你更好地在暗黑模式下开发出优秀的页面。</p>`,19);function A(h,F,g,d,u,m){const a=p("ZoomImg");return e(),o("div",null,[c,n(a,{src:"/theme.gif"}),r,n(a,{src:"/menu-fill-style.png"}),i,n(a,{src:"/menu-active-style.png"}),y,n(a,{src:"/breadcrumb-style.png"}),D,n(a,{src:"/tabbar-style.png"}),C])}const b=l(t,[["render",A]]);export{v as __pageData,b as default};
